...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          ...
          _c(
            "view",
            {
              staticClass: _vm._$s(7, "sc", "input-text"),
              style: _vm._$s(
                7,
                "s",
                _vm.ispdFocus
            ...
            [
              ...
              _c("u-input", {
                ...
                model: {
                  value: _vm._$s(9, "v-model", _vm.userLoginInfo.password),
                  callback: function($$v) {
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  _vm._v(
                    _vm._$s(11, "t0-0", _vm._s(_vm.isLogining ? "" : "登 录"))
                  )
                ]
              )
            ],
      ...
      _c("view", {
        staticClass: _vm._$s(13, "sc", "copy-right"),
        attrs: { _i: 13 }
      })
    ]
  )
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 29));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err);}_next(undefined);});};} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      // ------------- 其他 -------------\n      userLoginInfo: {\n        userName: '',\n        password: '' },\n\n\n      // 整体容器高度，单位 rpx\n\n      // containerHeight: 1000,\n      containerHeight: {\n        focus: 'height:800rpx;transition:0.2s',\n        blur: 'height:1300rpx;transition:0.2s' },\n\n\n      // 获取焦点时，整体上移的动画效果\n      animationData: {},\n\n      // 登录界面的用户图标\n      userImg: '../../static/img/user.png',\n\n      // 是否正在清除\n      isClearing: false,\n\n      // ------------- 输入框 -------------\n      pdMaxLength: 10,\n      // 输入框是否获取到焦点\n      isuserFocus: false,\n      ispdFocus: false,\n\n      // 输入框自定义样式\n      customStyle: {\n        \"padding-left\": \"40rpx\",\n        // 使光标消失（iOS无效果）\n        \"color\": \"transparent\",\n        \"text-shadow\": \"0 0 0 #000\" },\n\n\n      // 清除按钮图标\n      clearImg: '../../static/img/clear.png',\n\n      // 输入框 label 样式\n      label_style: {\n        focus: 'width:100rpx;display:flex;justify-content:center;color:#FF5242;font-weight:bold;transform:scale(1.1)',\n        blur: 'width:100rpx;display:flex;justify-content:center;color:#aaaaaa;transform:scale(1)' },\n\n\n      input_boder_style: {\n        focus: 'border-bottom: 1px solid #FF5242;',\n        blur: 'border-bottom: 1px solid #e4e4e4;' },\n\n\n      // ------------- 登录按钮 -------------\n      // 登录按钮自定义样式\n      login_btn_style: {\n        able: {\n          \"width\": \"100%\",\n          \"height\": \"100rpx\",\n          \"border-radius\": \"20rpx\",\n          \"border\": \"#e4e4e4\",\n          \"background-color\": \"#FF5242\",\n          \"color\": \"#fff\" },\n\n        disabled: {\n          \"width\": \"100%\",\n          \"height\": \"100rpx\",\n          \"border-radius\": \"20rpx\",\n          \"border\": \"#e4e4e4\",\n          \"background-color\": \"#FF5242\",\n          \"color\": \"#fff\",\n          \"opacity\": \"0.5\" } },\n\n\n\n      // 点击登录按钮后，接口返回数据前，对该操作上锁\n      isLogining: false,\n\n      isDisabledBtn: true };\n\n  },\n  methods: {\n    userFocus: function userFocus() {\n      // 是否在焦点上\n      this.isuserFocus = true;\n    },\n    userBlur: function userBlur() {\n      this.isuserFocus = false;\n    },\n\n    pdFocus: function pdFocus() {\n      this.ispdFocus = true;\n    },\n    pdBlur: function pdBlur() {\n      this.ispdFocus = false;\n    },\n\n    login: function login() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:\n                if (_this.isDisabledBtn) {\n                  // 登录按钮被禁用时\n                  _this.$Toast.unCompleteToast();\n                } else {\n                  // isLogining：显示按钮 loading 样式\n                  _this.isLogining = true;\n\n                  _this.$request({\n                    url: '/login',\n                    method: 'POST',\n                    data: {\n                      userName: _this.userLoginInfo.userName,\n                      password: _this.userLoginInfo.password } }).\n\n                  then(function (res) {\n                    // 密码正确\n                    _this.isLogining = false;\n                    if (res.data.isSuccess) {\n                      _this.$refs.uToast.show({\n                        title: '登录成功',\n                        type: 'success',\n                        // 登录成功后跳转到首页\n                        url: '/pages/form/index',\n                        // url 默认 navigateTo，isTab 配置为 switchTab\n                        isTab: true });\n\n                    }\n                  }).catch(function () {\n                    // 密码错误\n                    _this.isLogining = false;\n                    _this.$refs.uToast.show({\n                      title: '帐号或密码错误',\n                      type: 'error' });\n\n                  });\n                }case 1:case \"end\":return _context.stop();}}}, _callee);}))();\n    } },\n\n  /**\n          * 警惕！！！去除状态栏的代码不可加！会导致 input 框焦点获取逻辑混乱，导致键盘弹出错误。\n          */\n  // onShow() {\n  // \t// 去除状态栏\n  // \tplus.navigator.setFullscreen(true);\n  // },\n  watch: {\n    userLoginInfo: {\n      handler: function handler(newVal, oldVal) {\n        if (newVal.userName !== '' && newVal.password !== '') {\n          this.isDisabledBtn = false;\n        } else {\n          this.isDisabledBtn = true;\n        }\n      },\n      deep: true } } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///28\n");
